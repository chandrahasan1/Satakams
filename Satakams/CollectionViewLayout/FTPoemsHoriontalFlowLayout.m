...
@implementation FTPoemsHoriontalFlowLayout
...
- (void)setUp {
    ...
    self.itemSize = CGSizeMake(568, 200);
...
- (void)setCellAttributes:(UICollectionViewLayoutAttributes *)attributes forVisibleRect:(CGRect)visibleRect
{
    ...
    if (ABS(distance) < ACTIVE_DISTANCE)
    {
        ...
        */
        ...
        attributes.alpha = ABS(ACTIVE_DISTANCE - ABS(distance)) + 1;
    }
    else
    {
